export const metadata = {
  ...
  export default function PoliticaPrivacidade() {
    return (
      <div className="container mx-auto bg-neutral-100 text-neutral-800 p-8 rounded-lg">
        <h1 className="text-h1 font-bold mb-8">Política de Privacidade</h1>
  
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">1. Introdução</h2>
          <p className="text-p1">
        ...
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">2. Dados Pessoais Coletados</h2>
          <p className="text-p1 mb-2">Coletamos os seguintes dados pessoais fornecidos voluntariamente por você:</p>
          <ul className="list-disc list-inside mb-4 text-p1">
            <li>Nome completo</li>
          ...
          <p className="text-p1 mb-2">Além disso, coletamos automaticamente informações técnicas, como:</p>
          <ul className="list-disc list-inside text-p1">
            <li>Endereço IP</li>
        ...
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">3. Finalidades do Tratamento de Dados</h2>
          <ul className="list-disc list-inside text-p1">
        ...
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">4. Compartilhamento de Dados</h2>
          <ul className="list-disc list-inside text-p1">
        ...
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">5. Armazenamento e Segurança dos Dados</h2>
          <p className="text-p1">
        ...
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">6. Seus Direitos</h2>
          <ul className="list-disc list-inside text-p1">
          ...
          <p className="text-p1 mt-2">
            Para exercer seus direitos, entre em contato conosco pelo e-mail: <a href="mailto:rogerio.gomes@atoth.com.br" className="text-blue-600 underline">contato@atoth.com.br</a>
          </p>
        </section>
  
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">7. Cookies</h2>
          <p className="text-p1">
        ...
        <section className="mb-8">
          <h2 className="text-h2 font-semibold mb-4">8. Alterações nesta Política</h2>
          <p className="text-p1">
        ...
        <section>
          <h2 className="text-h2 font-semibold mb-4">9. Contato</h2>
          <p className="text-p1 mb-1">Se você tiver dúvidas ou preocupações sobre esta Política de Privacidade, entre em contato conosco:</p>
          <p className="text-p1">E-mail: <a href="mailto:rogerio.gomes@atoth.com.br" className="text-blue-600 underline">contato@atoth.com.br</a></p>
          <p className="text-p1">Telefone: +55 11 98364-6546</p>
          <p className="text-p1">Endereço: São Paulo, Brasil</p>
        </section>
      </div>
    )
  }
